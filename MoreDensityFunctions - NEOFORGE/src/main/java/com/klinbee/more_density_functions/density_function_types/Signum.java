...
public record Signum(DensityFunction df) implements PureTransformer {

    private static final MapCodec<Signum> DATA_CODEC = RecordCodecBuilder.mapCodec((instance) -> instance.group(DensityFunction.HOLDER_HELPER_CODEC.fieldOf("argument").forGetter(Signum::df)).apply(instance, Signum::new));
    public static final KeyDispatchDataCodec<Signum> CODEC = KeyDispatchDataCodec.of(DATA_CODEC);

...
public record Sqrt(DensityFunction df) implements DensityFunctionTypes.Unary {
    ...
    private static final MapCodec<Sqrt> MAP_CODEC = RecordCodecBuilder.mapCodec((instance) -> instance.group(DensityFunction.FUNCTION_CODEC.fieldOf("argument").forGetter(Sqrt::df)).apply(instance, (Sqrt::new)));

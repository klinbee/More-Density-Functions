...
import com.klinbee.moredensityfunctions.randomgenerators.NormalSampler;
...
public record NormalDistribution(double mean, double stdDev, NormalSampler rand) implements RandomDistribution {
    ...
    ).apply(instance, (mean, stdDev) -> new NormalDistribution(mean, stdDev, RandomSampler.buildNormal(mean, stdDev))));

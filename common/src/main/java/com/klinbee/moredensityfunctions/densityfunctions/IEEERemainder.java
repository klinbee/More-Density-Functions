...
public record IEEERemainder(DensityFunction numerator, DensityFunction denominator, Optional<DensityFunction> argError) implements DensityFunction {
    private static final MapCodec<IEEERemainder> MAP_CODEC = RecordCodecBuilder.mapCodec((instance) -> instance.group(DensityFunction.HOLDER_HELPER_CODEC.fieldOf("argument").forGetter(IEEERemainder::numerator), DensityFunction.HOLDER_HELPER_CODEC.fieldOf("arg").forGetter(IEEERemainder::denominator), DensityFunction.HOLDER_HELPER_CODEC.optionalFieldOf("error_argument").forGetter(IEEERemainder::argError)).apply(instance, (IEEERemainder::new)));

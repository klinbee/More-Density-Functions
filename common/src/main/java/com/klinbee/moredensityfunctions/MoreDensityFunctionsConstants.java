...
public class MoreDensityFunctionsConstants {
    ...
    public static final ResourceKey<Registry<RandomSampler>> RANDOM_SAMPLER = ResourceKey.createRegistryKey(ResourceLocation.fromNamespaceAndPath(MoreDensityFunctionsConstants.MOD_NAMESPACE, "random_sampler"));
    public static final ResourceKey<Registry<MapCodec<? extends RandomSampler>>> RANDOM_SAMPLER_TYPE = ResourceKey.createRegistryKey(ResourceLocation.fromNamespaceAndPath(MoreDensityFunctionsConstants.MOD_NAMESPACE, "random_sampler_type"));
}